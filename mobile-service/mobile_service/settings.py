...
SECRET_KEY = 'django-insecure-7c58fybb7z@&e+j7(e%_kew(3673n6_uxjs%#r%ts^w@hxtxf$'
...
if DB_ENGINE == 'django.db.backends.mysql':
    DATABASES = {
        'default': {
            'ENGINE': DB_ENGINE,
            'NAME': os.getenv('DB_MYSQL_NAME', 'ktra1_mobile_db'),
    ...
    DATABASES = {
        'default': {
            'ENGINE': DB_ENGINE,
            'NAME': os.getenv('DB_POSTGRES_NAME', 'ktra1_mobile_db'),
