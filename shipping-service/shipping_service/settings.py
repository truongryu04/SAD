...
SECRET_KEY = "django-insecure-shipping-service-change-me"
DEBUG = True
...
if DB_ENGINE == "django.db.backends.sqlite3":
    ...
    DATABASES = {
        "default": {
            "ENGINE": DB_ENGINE,
            "NAME": os.getenv("DB_POSTGRES_NAME", os.getenv("POSTGRES_DB", "shipping_service_db")),
...
SHIPPING_SERVICE_PORT = int(os.getenv("SHIPPING_SERVICE_PORT", "8009"))
